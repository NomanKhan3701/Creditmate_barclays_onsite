...
async function sendPushNotification(expoPushToken, num) {
  let message = {
    to: expoPushToken,
    sound: "default",
    vibrate: true,
    title: "Offers near you",
    body: "20% off on Adidas shoes",
  ...
  if (num == 2) {
    message = {
      ...
      sound: "default",
      vibrate: true,
      title: "Are you a Wimbledon fan?",
      body: "Congratulations! Stand a chance to win to Tickets to Wimbledon if you purchase items from the sports store near you!",
      data: { someData: "goes here" },
    };
  }
...
const BackgroundMap = ({ pin, setPin }) => {
  ...
  const pushNotifyMe = async (num) => {
    await sendPushNotification(expoPushToken, num);
  };
  useEffect(() => {
